...
@RequestMapping(value = "/bs-ms-project-api")
public class ProjectController {
    private final InputProjectService inputProjectService;
    @GetMapping(value = "")
    public ResponseEntity<Object> getWelcome(){
        return new ResponseEntity<>("welcome to business-microservice-project managing projects and employees, companies assigned", HttpStatus.OK);
    }
